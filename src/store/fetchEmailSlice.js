...
export const postEmail = (mailBody) => {
    ...
    return async (dispatch, getState) => {
        try {
            await axios.post(
                `https://chatbox-76072-default-rtdb.firebaseio.com/emails/${receiverMail}/receive.json`,
                {
                    ...mailBody,
                }
            );
            ...
            await axios.post(
                `https://chatbox-76072-default-rtdb.firebaseio.com/emails/${email}/sent.json`,
                {
                    ...mailBody,
                }
            );
    ...
    return async (dispatch, getState) => {
        try {
            const receivedResponse = await axios.get(
                `https://chatbox-76072-default-rtdb.firebaseio.com/emails/${email}/receive.json`
            );
    ...
    return async (dispatch, getState) => {
        try {
            const updateResponse = await axios.put(
                `https://chatbox-76072-default-rtdb.firebaseio.com/emails/${email}/receive/${id}.json`, { ...obj, isRead: true }
            );
    ...
    return async (dispatch, getState) => {
        try {
            const deleteResponse = await axios.delete(
                `https://chatbox-76072-default-rtdb.firebaseio.com/emails/${email}/${endpoint}/${id}.json`);
